...
<div class="" style="padding-top:200px;padding-bottom:100px;">
        ...
        <form class="form-horizontal form-signin" action="insert_guide_signup" method="get" onSubmit="return checkPassword(this)"> 
	      ...
	      <div><a href="<s:url value="#"/>">Login Instead</a></div>
	      <br>
	      <br>
	      <button class="btn btn-lg btn-primary btn-block" type="submit">Proceed Further</button> 
